...
KeycloakLSManager.KEY_PROCESSING_ACTION_USER_DISBLED = "userDisabled";

// ---------------------------------------------------------------------------------------------

KeycloakLSManager.setKeycloakInfo_ByKeycloakObj = function (kcObj) {
	KeycloakLSManager.setKeycloakInfo_ByTokens(kcObj.token, kcObj.refreshToken, kcObj.idToken);
}


KeycloakLSManager.setKeycloakInfo_ByTokens = function (accessToken, refreshToken, idToken) {
	updatePropertyValue(KeycloakLSManager.KEY_LOGIN_DATE, UtilDate.dateStr("DATETIME"));
	
	updatePropertyValue(KeycloakLSManager.KEY_ACCESS_TOKEN, accessToken);
	updatePropertyValue(KeycloakLSManager.KEY_REFRESH_TOKEN, refreshToken);
	updatePropertyValue(KeycloakLSManager.KEY_ID_TOKEN, idToken);
}
