	...
	me.viewFilterData = function (viewDef, mainList) {
		...
		if (!viewDef.dataFilterEval) Util.appendArray(filteredData, mainList);
			...
			mainList.forEach(client => {
				...
				} catch (errMsg) { console.log('ClientListView.viewFilterData, id: ' + viewDef.id + ', preRunEval, ' + errMsg); }
				...
				} catch (errMsg) { console.log('ClientListView.viewFilterData, id: ' + viewDef.id + ', dataFilterEval, ' + errMsg); }
			});
		}
