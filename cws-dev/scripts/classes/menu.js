...
Menu.menuJson_Settings = { id: "settingsPage", name: "Settings", term: "", icon: "settings", groupBefore: false, groupAfter: false };
...
Menu.menuJson_About = { id: "aboutPage", name: "About", term: "", icon: "about", groupBefore: true, groupAfter: true };
