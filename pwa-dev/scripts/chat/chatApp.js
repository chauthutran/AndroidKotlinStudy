...
function ChatApp( username )
{
    ...
    me.selectedUser;
	me.users = [];
	me.serverURL = ( WsCallManager.isLocalDevCase ) ? serverURL_local : serverURL;
    ...
    me.init = function() 
	 {
        ...
        $.get( me.serverURL + "/users?username=" + me.username,{}, function( userProfile )
		  {
				me.initSocket();
